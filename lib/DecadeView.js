...
var DecadeView = function (_Component) {
  ...
  function DecadeView() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(DecadeView).apply(this, arguments));
  }
  ...
  _createClass(DecadeView, [{
    ...
    key: 'renderYears',
    value: function renderYears(props, days) {
      var _this2 = this;

      var nodes = days.map(function (date, index, arr) {
        return _this2.renderYear(props, date, index, arr);
      });
      var len = days.length;
      var buckets = [];
    ...
    key: 'renderYear',
    value: function renderYear(props, date, index, arr) {
...
DecadeView.propTypes = (0, _asConfig2.default)();