  ...
  _createClass(Clock, [{
    ...
    value: function renderTick(tick) {
      ...
      var _p = this.p,
          ...
          tickWidth = _p.tickWidth,
          smallTickWidth = _p.smallTickWidth,
          bigTickWidth = _p.bigTickWidth,
          tickHeight = _p.tickHeight,
          smallTickHeight = _p.smallTickHeight,
          bigTickHeight = _p.bigTickHeight,
          tickOffset = _p.tickOffset,
          smallTickOffset = _p.smallTickOffset,
          bigTickOffset = _p.bigTickOffset;
