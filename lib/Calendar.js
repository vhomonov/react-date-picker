...
var Calendar = function (_Component) {
  ...
  _createClass(Calendar, [{
    ...
    value: function renderClockInput() {
      ...
      var clockInput = _react2.default.Children.toArray(this.props.children).filter(function (child) {
        return child && child.props && child.props.isClockInput;
      })[0];
      ...
      if (clockInput) {
        (0, _assignDefined2.default)(clockInputProps, clockInput.props);
